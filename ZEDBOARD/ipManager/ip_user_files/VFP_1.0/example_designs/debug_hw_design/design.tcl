...
proc create_ipi_design { offsetfile design_name } {
	...
	connect_bd_net [get_bd_pins VFP_0/rgb_s_axis_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins VFP_0/rgb_s_axis_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins VFP_0/m_axis_mm2s_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins VFP_0/m_axis_mm2s_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins VFP_0/rgb_m_axis_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins VFP_0/rgb_m_axis_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]

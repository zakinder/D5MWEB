...
#
# Generated by export_simulation on Sun Jun 09 21:16:17 -0700 2019
#
################################################################################
...
switch to the './videoProcess_tb.sh' script.

./videoProcess_tb.sh -reset_run
...
./videoProcess_tb.sh -noclean_files

For more information on the script, please type './videoProcess_tb.sh -help'.

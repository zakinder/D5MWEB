...
#
# Generated by Vivado on Sun Jun 09 21:13:40 -0700 2019
# IP Build 1971916 on Wed Aug 23 13:11:02 MDT 2017 
#
# usage: videoProcess_tb.sh [-help]
# usage: videoProcess_tb.sh [-lib_map_path]
# usage: videoProcess_tb.sh [-noclean_files]
# usage: videoProcess_tb.sh [-reset_run]
#
# ********************************************************************************************************

xv_path="C:/Xilinx/SDx/2017.2/Vivado"
...
# Script info
echo -e "videoProcess_tb.sh - Script generated by export_simulation (Vivado v2017.2_sdx (64-bit)-id)\n"
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./videoProcess_tb.sh -help\" for more information)\n"
        exit 1
      fi
     copy_setup_file $2
    ;;
...
{
  file="xsim.ini"
  lib_map_path="C:/Xilinx/SDx/2017.2/Vivado/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb videoProcess_tb.wdb xsim.dir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./videoProcess_tb.sh -help\" for more information)\n"
    exit 1
  fi
...
usage()
{
  msg="Usage: videoProcess_tb.sh [-help]\n\
Usage: videoProcess_tb.sh [-lib_map_path]\n\
Usage: videoProcess_tb.sh [-reset_run]\n\
Usage: videoProcess_tb.sh [-noclean_files]\n\n\

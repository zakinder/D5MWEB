...
begin
    ...
    pRegion.pointInterest   <= to_integer(unsigned(wrRegsIn.cfigReg31(15 downto 0)));--set the point
    pRegion.deltaConfig     <= to_integer(unsigned(wrRegsIn.cfigReg32(15 downto 0)));--set the point delta

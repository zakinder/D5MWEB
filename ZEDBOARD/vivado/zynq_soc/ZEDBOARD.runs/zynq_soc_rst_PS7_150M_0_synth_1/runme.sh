...
HD_PWD='C:/Users/GATE/Documents/GitHub/D5MWEB/ZEDBOARD/vivado/zynq_soc/ZEDBOARD.runs/zynq_soc_rst_PS7_150M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zynq_soc_rst_PS7_150M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zynq_soc_rst_PS7_150M_0.tcl
